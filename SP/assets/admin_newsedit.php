...
if(newsheader!="" && newstext!="" ){
    
$("#newsadd").attr("disabled", true);
...
/
  ...
  $.ajax({
      ...
      url: "insertnews.php",
      dataType: "json",
      data: {newsheader:newsheader,newstext:newstext},
      cache:false
 ...
 if(newsheaeventname var n=document.getElementById("newsheaeventnametyle.borderColor="red";
 n.style.border="1px";
 ...
 if(newstext==""){
 var m=document.getElementById("newstext");
...
<a  href="admin.php"><i class="fa fa-home"></i> Dashboard</a> 
  ...
  <a class="active" href="admin_newsedit.php"><i class="fa fa-edit"></i> Edit News</a>
        ...
        <div class="col-xs-9 ">
            <div class="rsidebar">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">Add News</a></li>
              
                    <li><a data-toggle="tab" href="#settings">Uploaded News</a></li>
                  </ul>
              ...
              <div  class="tab-content">
                <div class="tab-pane active" id="home" style="background-color: white;">
                    ...
                    <form action="insertnews.php" method="POST" name="addnewsform"  id="addnewsform">
                          ...
                          <div class="form-group" style="background-color: #d5d5d5;" >
                              ...
                              <div class="col-xs-6" >
                                 ...
                                 <input style="border-radius:25px;" type="text" class="form-control" id="newsheader"name="newsheader"  placeholder="News Header" >
                                 <h4><strong>Detail</strong></h4>
                                  <input style="border-radius:25px;" type="text" id="newstext"  name="newstext" class="form-control" placeholder="Write the brief news" >
                                  <button  id="newsadd" style="border-radius:25px;margin-left: 2%;margin-top: 4%;" class="btn btn-lg btn-success" type="submit" name="save"><i class="glyphicon glyphicon-ok-sign"></i> Save</button>
