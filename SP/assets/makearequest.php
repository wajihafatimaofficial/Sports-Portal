...
<div class="container" >
  ...
  <div class="row"  style="background-color: rgb(69, 233, 197);box-shadow: 3px 3px 5px 5px;border-radius: 25px;">
    <h1 style="text-align:center;color:black;">Make a Request</h1>
    <hr>
    ...
    <div class="col-sm-6">
      <div class="form-group">
        <div class="controls">
          <label>Name</label>
          <input style="border-radius:25px;" type="text" id="name" name="name"  class="form-control" placeholder="Name">
        </div>
      </div>
