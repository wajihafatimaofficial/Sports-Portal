...
<title>Admin/Contact Forms</title>
...
<a  href="admin.php"><i class="fa fa-home"></i> Dashboard</a> 
  ...
  <a class="active"  href="admin_feedback.php"><i class="fa fa-comments"></i> Feedback & Complaints</a> 
</div>
...
<div style="overflow-x:auto;" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12">
                               <h2 style="text-align:center;">Feedbacks & Complaints</h2>
             ...
             $result = mysqli_query($conn,"SELECT * FROM contactform");
             for ($x = 1; $x <= 10; $x++) {
