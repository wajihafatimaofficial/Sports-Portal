<?php 
    ...
    $sql1="SELECT * FROM  signup  WHERE StudentId='" . $_SESSION["StudentId"] . "'  ";
    $edit1 = mysqli_query($conn,$sql1);
    while($row = mysqli_fetch_array($edit1)){
      $Name= $row['FirstName'];
      $Email= $row['Email'];}
?>
      ...
      <ul class="nav navbar-nav navbar-right ">
        ...
        <li class="nav-item dropdown dropdown-slide">
          <a class="nav-link" href="#" data-toggle="dropdown"><span>&#x25BC;</span></a>
            <!-- Dropdown list -->
            <div class="dropdown-menu" style="background-color:#777;">
              <a class="dropdown-item" href="http://localhost/SP/assets/signup.php" style="display:block;">-Sign In</a>
...
<div class="container" >
  ...
  <div class="row"  style="background-color: rgb(69, 233, 197);box-shadow: 3px 3px 5px 5px;border-radius: 25px;">
    <h1 style="text-align:center;color:black;">Join a Team</h1>
    <hr>
    <form action="insertjointeam.php" method="POST" name="contactform"  id="contactForm">
    ...
    <div class="col-sm-6">
      <div class="form-group">
        <div class="controls">
          <label>Name</label>
          <input value="<?php echo $Name?>" style="border-radius:25px;" type="text" id="name" name="name"  class="form-control" placeholder="Name">
        </div>
      </div>
   ...
   <div class="col-sm-6">
    ...
    <div class="form-group">
      <div class="controls">
        <label>Email</label>
        <input value="<?php echo $Email;?>" style="border-radius:25px;"  type="text" name="email"  class="email form-control" id="email" placeholder="user@somewhere.com" >
      </div>
    </div>
...
<div class="col-sm-12">
  ...
  <div class="form-group">
    <div class="controls">
      <label>Subject</label>
       ...
       <select style="border-radius:25px;" id="msg_subject"  name="msg_subject" class="form-control" placeholder="Please select a sport">
        <option value="" selected disabled hidden>Please select sport</option>        
        ...
        <option>ONO</option>
        <option>Scrrable</option>
        <option>Drafth</option>
  ...
  <div class="form-group">
    <div class="controls">
      <label>Request</label>
      <textarea  style="border-radius:25px;" id="message" name="message"  rows="7" placeholder="Please briefly describe your request" class="form-control "></textarea>
    </div>  
  </div>
